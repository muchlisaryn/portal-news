...
export default function Lifestyle() {
  ...
  const lifestyleNews = async () => {
    ...
    try {
      const response = await axios.get(
        `https://newsapi.org/v2/everything?q=lifestyle&from=2023-02-24&sortBy=publishedAt&apiKey=${process.env.REACT_APP_API_KEY}`,
        {
  ...
  return (
    <div>
      <Navbar />
      <div className="my-4 text-center">LIFESTYLE NEWS</div>
